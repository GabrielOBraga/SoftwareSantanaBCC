...
<body id="page-login"  background="../../santanabcc/img/fundosantana.png" style="background-size: 100%">
...
<div style=" margin: 0 12.5% ; position: relative; top:0 ">
    ...
    <form action="/santanabcc/front.php/cFuncionario" method="get">
        <button class="btn btn-link">Cadastro de Funcionarios</button>
    </form>


    <form action="/santanabcc/front.php/vendas" method="get">
        <button class="btn btn-link">Vendas</button>
    </form>

    <form action="/santanabcc/front.php/cProdutos" method="get">
